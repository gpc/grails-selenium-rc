...
class DefaultSeleniumServerRunner implements SeleniumServerRunner {

	private final SeleniumTestContext context
	private seleniumServer

	DefaultSeleniumServerRunner(SeleniumTestContext context) {
	...
	private boolean runInSlowMode() {
		context.config.selenium.slow ?: false
	}
